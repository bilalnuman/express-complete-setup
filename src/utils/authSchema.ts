...
export const registerSchema = z.object({
    ...
    firstName: z.string().min(3, "FirstName too short")
        ...
        .regex(/^[a-zA-Z0-9_]+$/, "FirstName can only contain letters, numbers, and underscores").optional(),
    lastName: z.string().min(3, "LastName too short")
        .max(20, "LastName too long")
        .regex(/^[a-zA-Z0-9_]+$/, "LastName can only contain letters, numbers, and underscores").optional(),
});
